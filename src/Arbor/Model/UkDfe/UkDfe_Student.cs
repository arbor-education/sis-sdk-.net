...
{
    public class UkDfe_Student : ModelBase
    {
        ...
        public UkDfe_Student ()
        {
            base.resourceType = this.resourceType;
        }
        
        public UkDfe_Student (string resourceType = "UkDfe_Student", Hashtable properties = null, IGateway apiGateway = null) 
        ...
        public static ModelCollection<UkDfe_Student> query (SimpleQuery query = null)
        {
            if (query == null) query = new SimpleQuery ();
        	query.setResourceType ("UkDfe_Student");
        	RestGateway gateway = (RestGateway) UkDfe_Student.getDefaultGateway ();
        	if(gateway == null) throw new Exception("You must call ModelBase.setDefaultGateway() prior to calling query()");
        
        	ModelCollection<UkDfe_Student> ukdfe_studentCollection = new ModelCollection<UkDfe_Student> ();
        	ModelCollection<ModelBase> collection = gateway.query (query);
        
        	foreach (ModelBase model in collection) {
        	    ukdfe_studentCollection.add((UkDfe_Student) model);
        	}
        
        	return ukdfe_studentCollection;
        }

        public static UkDfe_Student retrieve (string id)
        {
            RestGateway gateway = (RestGateway) UkDfe_Student.getDefaultGateway();
        	if(gateway == null) throw new Exception("You must call ModelBase::setDefaultGateway() prior to calling query()");
        	return (UkDfe_Student) gateway.retrieve(ResourceType.UK_DFE_STUDENT, id);
        }

...
{
    public class UkDfe_SchoolWorkforceCensusReturn : ModelBase
    {
        ...
        public UkDfe_SchoolWorkforceCensusReturn ()
        {
            base.resourceType = this.resourceType;
        }
        
        public UkDfe_SchoolWorkforceCensusReturn (string resourceType = "UkDfe_SchoolWorkforceCensusReturn", Hashtable properties = null, IGateway apiGateway = null) 
        ...
        public static ModelCollection<UkDfe_SchoolWorkforceCensusReturn> query (SimpleQuery query = null)
        {
            if (query == null) query = new SimpleQuery ();
        	query.setResourceType ("UkDfe_SchoolWorkforceCensusReturn");
        	RestGateway gateway = (RestGateway) UkDfe_SchoolWorkforceCensusReturn.getDefaultGateway ();
        	if(gateway == null) throw new Exception("You must call ModelBase.setDefaultGateway() prior to calling query()");
        
        	ModelCollection<UkDfe_SchoolWorkforceCensusReturn> ukdfe_schoolworkforcecensusreturnCollection = new ModelCollection<UkDfe_SchoolWorkforceCensusReturn> ();
        	ModelCollection<ModelBase> collection = gateway.query (query);
        
        	foreach (ModelBase model in collection) {
        	    ukdfe_schoolworkforcecensusreturnCollection.add((UkDfe_SchoolWorkforceCensusReturn) model);
        	}
        
        	return ukdfe_schoolworkforcecensusreturnCollection;
        }

        public static UkDfe_SchoolWorkforceCensusReturn retrieve (string id)
        {
            RestGateway gateway = (RestGateway) UkDfe_SchoolWorkforceCensusReturn.getDefaultGateway();
        	if(gateway == null) throw new Exception("You must call ModelBase::setDefaultGateway() prior to calling query()");
        	return (UkDfe_SchoolWorkforceCensusReturn) gateway.retrieve(ResourceType.UK_DFE_SCHOOL_WORKFORCE_CENSUS_RETURN, id);
        }

...
namespace Arbor.Model
{
    public class Kpi : ModelBase
    {
        ...
        {
            return (bool) this.getProperty("calculateForSchool");
        }
        ...
        {
            return (bool) this.getProperty("calculateForGroups");
        }
        ...
        {
            return (bool) this.getProperty("calculateForAcademicUnits");
        }
        ...
        {
            return (bool) this.getProperty("calculateForStudents");
        }
        ...
        {
            return (bool) this.getProperty("calculateForStudentAcademicUnitEnrolments");
        }

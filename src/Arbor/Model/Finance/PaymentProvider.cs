...
namespace Arbor.Model.Finance
{
    ...
    {
        protected string resourceType = ResourceType.FINANCE_PAYMENT_PROVIDER;
        ...
        public const string SCHOOL_COVERS_FEE = "schoolCoversFee";
        public const string FEE_PERCENTAGE = "feePercentage";
        ...
        public static ModelCollection<PaymentProvider> query (SimpleQuery query = null)
        {
        	...
        	query.setResourceType ("Finance_PaymentProvider");
        ...
        public static PaymentProvider retrieve (string id)
        {
            RestGateway gateway = (RestGateway) PaymentProvider.getDefaultGateway();
        	if(gateway == null) throw new Exception("You must call ModelBase::setDefaultGateway() prior to calling query()");
        	return (PaymentProvider) gateway.retrieve(ResourceType.FINANCE_PAYMENT_PROVIDER, id);
        }
        ...
        public bool getSchoolCoversFee ()
        {
            return (bool) this.getProperty("schoolCoversFee");
        }

        public void setSchoolCoversFee (bool schoolCoversFee)
        {
        ...
        {
            return (float) this.getProperty("feePercentage");
        }

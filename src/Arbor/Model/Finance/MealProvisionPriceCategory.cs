...
namespace Arbor.Model.Finance
{
    ...
    {
        protected string resourceType = ResourceType.FINANCE_MEAL_PROVISION_PRICE_CATEGORY;
        ...
        public static ModelCollection<MealProvisionPriceCategory> query (SimpleQuery query = null)
        {
        	...
        	query.setResourceType ("Finance_MealProvisionPriceCategory");
        ...
        public static MealProvisionPriceCategory retrieve (string id)
        {
            RestGateway gateway = (RestGateway) MealProvisionPriceCategory.getDefaultGateway();
        	if(gateway == null) throw new Exception("You must call ModelBase::setDefaultGateway() prior to calling query()");
        	return (MealProvisionPriceCategory) gateway.retrieve(ResourceType.FINANCE_MEAL_PROVISION_PRICE_CATEGORY, id);
        }

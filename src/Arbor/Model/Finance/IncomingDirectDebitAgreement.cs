...
namespace Arbor.Model.Finance
{
    ...
    {
        protected string resourceType = ResourceType.FINANCE_INCOMING_DIRECT_DEBIT_AGREEMENT;
        ...
        public static ModelCollection<IncomingDirectDebitAgreement> query (SimpleQuery query = null)
        {
        	...
        	query.setResourceType ("Finance_IncomingDirectDebitAgreement");
        ...
        public static IncomingDirectDebitAgreement retrieve (string id)
        {
            RestGateway gateway = (RestGateway) IncomingDirectDebitAgreement.getDefaultGateway();
        	if(gateway == null) throw new Exception("You must call ModelBase::setDefaultGateway() prior to calling query()");
        	return (IncomingDirectDebitAgreement) gateway.retrieve(ResourceType.FINANCE_INCOMING_DIRECT_DEBIT_AGREEMENT, id);
        }

...
namespace Arbor.Model.Finance
{
    ...
    {
        protected string resourceType = ResourceType.FINANCE_INCOMING_DIRECT_DEBIT_TRANSACTION;
        ...
        public static ModelCollection<IncomingDirectDebitTransaction> query (SimpleQuery query = null)
        {
        	...
        	query.setResourceType ("Finance_IncomingDirectDebitTransaction");
        ...
        public static IncomingDirectDebitTransaction retrieve (string id)
        {
            RestGateway gateway = (RestGateway) IncomingDirectDebitTransaction.getDefaultGateway();
        	if(gateway == null) throw new Exception("You must call ModelBase::setDefaultGateway() prior to calling query()");
        	return (IncomingDirectDebitTransaction) gateway.retrieve(ResourceType.FINANCE_INCOMING_DIRECT_DEBIT_TRANSACTION, id);
        }

        public ModelBase getIncomingDirectDebitAgreement ()
        {
            return (ModelBase) this.getProperty("incomingDirectDebitAgreement");
        }

        public void setIncomingDirectDebitAgreement (ModelBase incomingDirectDebitAgreement)
        {

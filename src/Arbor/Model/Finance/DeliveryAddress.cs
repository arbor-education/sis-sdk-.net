...
namespace Arbor.Model.Finance
{
    ...
    {
        protected string resourceType = ResourceType.FINANCE_DELIVERY_ADDRESS;
        ...
        public static ModelCollection<DeliveryAddress> query (SimpleQuery query = null)
        {
        	...
        	query.setResourceType ("Finance_DeliveryAddress");
        ...
        public static DeliveryAddress retrieve (string id)
        {
            RestGateway gateway = (RestGateway) DeliveryAddress.getDefaultGateway();
        	if(gateway == null) throw new Exception("You must call ModelBase::setDefaultGateway() prior to calling query()");
        	return (DeliveryAddress) gateway.retrieve(ResourceType.FINANCE_DELIVERY_ADDRESS, id);
        }
        ...
        {
            return (bool) this.getProperty("isAddressForReuse");
        }

...
namespace Arbor.Model
{
    public class CustomReportScheduledExport : ModelBase
    {
        ...
        {
            return (bool) this.getProperty("executeOnMonday");
        }
        ...
        {
            return (bool) this.getProperty("executeOnTuesday");
        }
        ...
        {
            return (bool) this.getProperty("executeOnWednesday");
        }
        ...
        {
            return (bool) this.getProperty("executeOnThursday");
        }
        ...
        {
            return (bool) this.getProperty("executeOnFriday");
        }
        ...
        {
            return (bool) this.getProperty("executeOnSaturday");
        }
        ...
        {
            return (bool) this.getProperty("executeOnSunday");
        }
